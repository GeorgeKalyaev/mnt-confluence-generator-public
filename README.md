...
Веб-приложение для автоматической генерации и публикации документов МНТ (Методика Нагрузочного Тестирования) в Confluence из удобной веб-формы.

## 📋 Описание

МНТ Confluence Generator — это инструмент для создания структурированных документов МНТ с последующей автоматической публикацией в Confluence. Приложение предоставляет интуитивно понятный веб-интерфейс с визуальными редакторами таблиц, автоматическим форматированием и интеграцией с Confluence API.

## ✨ Основные возможности

- 📝 **Создание и редактирование МНТ** через веб-интерфейс
- 📊 **Визуальные редакторы таблиц** для всех разделов документа
- 🏷️ **Система тегов** для категоризации документов
...
1. При создании или редактировании выберите "Сохранить и сгенерировать в Confluence"
