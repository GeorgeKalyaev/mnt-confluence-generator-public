...
> **Примечание:** Здесь будут размещены скриншоты интерфейса приложения. Добавьте изображения в папку `docs/screenshots/` и обновите ссылки ниже.

### Главная страница - Список МНТ

![Список МНТ](docs/screenshots/list-page.png)

*Главная страница со списком всех документов МНТ, возможностью поиска, фильтрации и сортировки.*

### Форма создания МНТ

![Создание МНТ](docs/screenshots/create-page.png)

*Веб-форма для создания нового документа МНТ с визуальными редакторами таблиц.*

### Визуальные редакторы таблиц

![Редакторы таблиц](docs/screenshots/table-editors.png)

*Пример визуального редактора таблиц для удобного заполнения разделов документа.*

### Форма редактирования МНТ

![Редактирование МНТ](docs/screenshots/edit-page.png)

*Интерфейс редактирования существующего документа МНТ с сохранением изменений.*

### Публикация в Confluence

![Публикация в Confluence](docs/screenshots/confluence-publish.png)
