...
DEFAULT_TERMINOLOGY = """Автоматизированная система|Совокупность прикладного программного обеспечения, являющаяся предметом исследования в проекте нагрузочного тестирования
...
DEFAULT_INTRODUCTION = """Настоящий документ описывает и определяет стратегию и принципы нагрузочного тестирования системы 'указать название системы' (далее – «Система» или «Продукт»).
